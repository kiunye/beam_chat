[
  ...
  # trips a `pattern_match_cov` warning. Suppress the wrapper, the wrapper's
  # caller in `direct.ex`, and the pattern-match warning in `chat_live`.
  ~r/lib\/beam_chat\/message_pipeline\/producer\.ex/,
