defmodule BeamChat.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["compile", "tailwind beam_chat", "esbuild beam_chat"],
      "assets.deploy": [
        "tailwind beam_chat --minify",
        "esbuild beam_chat --minify",
        "phx.digest"
      ],
      precommit: [
