defmodule BeamChatWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BeamChatWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BeamChatWeb.Gettext, "errors", msg, opts)
    end
  end
